...
const exercises = [
  ...
  { name: 'Parallettes Push-Up', slug: 'parallettes-push-up', category: ExerciseCategory.CHEST, primaryMuscle: MuscleGroup.CHEST, equipment: Equipment.BODYWEIGHT, instructions: 'Perform push-ups holding parallettes for increased range of motion.' },
  ...
  { name: 'Scapular Pull-Up', slug: 'scapular-pull-up', category: ExerciseCategory.BACK, primaryMuscle: MuscleGroup.UPPER_BACK, equipment: Equipment.BODYWEIGHT, instructions: 'Hang from bar with arms straight. Engage upper back and shoulder blades to pull body up slightly without bending elbows.' },
  { name: 'Negative Pull-Up', slug: 'negative-pull-up', category: ExerciseCategory.BACK, primaryMuscle: MuscleGroup.LATS, equipment: Equipment.BODYWEIGHT, instructions: 'Start at top position with chin over bar (using bench/jump), lower body slowly over 3-5 seconds.' },
  { name: 'One-Arm Dumbbell Row', slug: 'one-arm-dumbbell-row', category: ExerciseCategory.BACK, primaryMuscle: MuscleGroup.LATS, equipment: Equipment.DUMBBELL, instructions: 'Brace on bench with one hand and knee. Pull dumbbell up to hip with working arm.' },
  { name: 'Dead Hang', slug: 'dead-hang', category: ExerciseCategory.BACK, primaryMuscle: MuscleGroup.FOREARMS, equipment: Equipment.BODYWEIGHT, instructions: 'Hang from pull-up bar with overhead grip, holding body still for duration to build grip strength and stretch shoulders.' },
  ...
  { name: 'One-Arm Shoulder Press', slug: 'one-arm-shoulder-press', category: ExerciseCategory.SHOULDERS, primaryMuscle: MuscleGroup.SHOULDERS, equipment: Equipment.DUMBBELL, instructions: 'Hold one dumbbell at shoulder level. Press straight up to full extension.' },
  { name: 'Pike Push-Up', slug: 'pike-push-up', category: ExerciseCategory.SHOULDERS, primaryMuscle: MuscleGroup.SHOULDERS, equipment: Equipment.BODYWEIGHT, instructions: 'Pike hips high in inverted V position. Lower top of head toward floor between hands, push back up.' },
  ...
  { name: 'One-Arm Lateral Raise', slug: 'one-arm-lateral-raise', category: ExerciseCategory.SHOULDERS, primaryMuscle: MuscleGroup.SHOULDERS, equipment: Equipment.DUMBBELL, instructions: 'Hold dumbbell in one hand, raise out to side until parallel to floor.' },
  ...
  { name: 'Reverse Fly', slug: 'reverse-fly', category: ExerciseCategory.SHOULDERS, primaryMuscle: MuscleGroup.SHOULDERS, equipment: Equipment.DUMBBELL, instructions: 'Bend at hips. Raise dumbbells out to sides squeezing rear delts and upper back.' },
  ...
  { name: 'One-Arm Curl', slug: 'one-arm-curl', category: ExerciseCategory.BICEPS, primaryMuscle: MuscleGroup.BICEPS, equipment: Equipment.DUMBBELL, instructions: 'Curl single dumbbell with one arm, focusing on bicep contraction.' },
  ...
  { name: 'One-Arm Overhead Triceps Extension', slug: 'one-arm-overhead-triceps-extension', category: ExerciseCategory.TRICEPS, primaryMuscle: MuscleGroup.TRICEPS, equipment: Equipment.DUMBBELL, instructions: 'Hold single dumbbell overhead with one hand. Lower behind head, extend arm up.' },
  ...
  { name: 'Goblet Squat', slug: 'goblet-squat', category: ExerciseCategory.LEGS, primaryMuscle: MuscleGroup.QUADS, equipment: Equipment.DUMBBELL, instructions: 'Hold dumbbell or kettlebell at chest height. Squat down with upright posture.' },
  ...
  { name: 'Lying Knee Raise', slug: 'lying-knee-raise', category: ExerciseCategory.CORE, primaryMuscle: MuscleGroup.ABS, equipment: Equipment.BODYWEIGHT, instructions: 'Lie flat on floor. Raise knees toward chest engaging lower abs, lower back down.' },
