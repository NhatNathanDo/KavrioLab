...
export default function BillingError({
  ...
  return (
    <div className="p-6 md:p-10 max-w-5xl mx-auto flex flex-col items-center justify-center min-h-[50vh] text-center">
      ...
      <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-2 max-w-md">
        An error occurred while connecting to the billing gateway or fetching subscription status.
      </p>
      <button
        onClick={() => reset()}
