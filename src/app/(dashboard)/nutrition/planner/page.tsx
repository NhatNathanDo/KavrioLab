        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50">
              {language === 'vi' ? 'Danh sách Đi chợ & Chuẩn bị món ăn (M16)' : 'Shopping List & Meal Prep Planner'}
            </h1>
        ...
        <div className="flex items-center gap-3">
          {checkedCount > 0 && (
            <button
              ...
              className="px-4 py-2.5 rounded-2xl bg-red-500/10 hover:bg-red-500/20 text-red-600 dark:text-red-400 font-bold text-xs transition-all flex items-center gap-1.5 border border-red-500/20"
            >
              <Trash2 className="w-3.5 h-3.5" />
              <span>{language === 'vi' ? `Xóa ${checkedCount} món đã mua` : `Clear ${checkedCount} Checked`}</span>
            </button>
          )}
          <button
            onClick={handleAutoGenerate}
            disabled={isGenerating}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs shadow-lg shadow-emerald-500/20 transition-all disabled:opacity-50"
          >
        ...
        <div className="bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-zinc-200/80 dark:border-zinc-800 shadow-sm space-y-4 md:col-span-1 h-fit">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs transition-all shadow-md mt-2 flex items-center justify-center gap-1.5"
            >
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-zinc-100 dark:border-zinc-800 pb-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-base text-zinc-900 dark:text-zinc-50">
                  {shoppingList?.name || 'Grocery Essentials'}
                </h3>
