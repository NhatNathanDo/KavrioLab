                    ...
                    {!collapsed && (
                      <div className="px-5 py-4 space-y-2">
                        <div
                          ...
                          style={{ gridTemplateColumns: '40px 64px 1fr 1fr 28px' }}
                        >
                        ...
                        <div className="space-y-1.5">
                          {ex.sets.map((set, sIdx) => (
                            <div
                              key={set.id}
                              className="grid items-center px-3 py-1 bg-zinc-50/50 dark:bg-zinc-900/30 rounded-xl"
                              style={{ gridTemplateColumns: '40px 64px 1fr 1fr 28px' }}
                            >
                              ...
                              <select
                                ...
                                onChange={(e) =>
                                  handleUpdateSet(ex.id, set.id, {
                                    setType: e.target.value as SetInput['setType'],
                                  })
                                }
                        ...
                        <button
                          ...
                          className="w-full mt-2 py-2 flex items-center justify-center gap-1.5 text-xs text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 border border-dashed border-zinc-200 dark:border-dashed border-zinc-200 dark:border-zinc-850 rounded-xl hover:border-zinc-350 dark:hover:border-zinc-750 transition-all"
                        >
