  ...
  return (
    <div className="min-h-screen bg-zinc-50/60 dark:bg-zinc-950/40 p-6 md:p-10 space-y-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* Scale Weight */}
        <div className="bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-zinc-200/80 dark:border-zinc-800 shadow-sm space-y-2">
          ...
          <p className="text-[11px] font-semibold text-zinc-400 italic">
            {language === 'vi' ? 'Số đo cân thực tế mới nhất' : 'Latest scale measurement'}
          </p>
        </div>
